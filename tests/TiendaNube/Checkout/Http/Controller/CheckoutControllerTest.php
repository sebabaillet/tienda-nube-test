...
{
    public function testGetAddressValidBeta()
    {$this->assertTrue(true);}
    public function testGetAddressInvalidBeta()
    {$this->assertTrue(true);}
    ...
    public function testGetAddressValid()
    {
        ...
        $checkoutService->method('getAddressByZip')->willReturn($address);

        // test
        $result = $controller->getAddressAction('40010000',$checkoutService);
    ...
    public function testGetAddressInvalid()
    {
        ...
        //mock the checkout service
        $checkoutService = $this->createMock(CheckoutService::class);
        $checkoutService->method('getAddressByZip')->willReturn([]);

        // test
        $result = $controller->getAddressAction('400100001',$checkoutService);
    ...
    public function testGetAddressWithServerError()
    {
        // getting controller instance
        $controller = $this->getControllerInstance();
        ...
        //mock the checkout service
        $checkoutService = $this->createMock(CheckoutService::class);
        $checkoutService->method('getAddressByZip')->willReturn(null);
        ...
        $this->assertEquals('{"error":"The server responded with a server error."}',$result->getBody()->getContents());
    }
